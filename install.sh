...
# ==============================================================================
# Title: Hvm Panel v5 - Ultimate Rainbow Edition
# Developer: ZENSEITECH
# ==============================================================================
...
print_rainbow() {
    local lines=(
        "################################################################################"
        "  _   _ __     __ __  __  ____   _      _   _  _____  _       "
        " | | | |\\ \\   / /|  \\/  ||  _ \\ / \\    | \\ | || ____|| |      "
        " | |_| | \\ \\ / / | |\\/| || |_) / _ \\   |  \\| ||  _|  | |      "
        " |  _  |  \\ V /  | |  | ||  __/ ___ \\  | |\\  || |___ | |___   "
...
# 2. Extracting Files (Updated to Hvm-v5.zip)
echo -e "${C4}--> [2/7] Unzipping Hvm-v5.zip assets...${NC}"
if [ -f "Hvm-v5.zip" ]; then
    unzip -o Hvm-v5.zip
    echo -e "${C3}✔ Hvm-v5 Files extracted successfully.${NC}"
else
    echo -e "${C1}✖ Error: Hvm-v5.zip not found! Upload the file first.${NC}"
fi
...
echo ""
echo -e "${C4}================================================================================${NC}"
echo -e " ${C3}✅ INSTALLATION FINISHED BY ZENSEITECH${NC}"
echo -e " ${WHITE}🌐 PORT:${NC} ${C2}3000${NC}"
echo -e " ${C6}🚀 STARTING HVM-V5 PANEL NOW...${NC}"
echo -e "${C4}================================================================================${NC}"
echo ""

# Run the panel
# Note: Ensure hvm.py is configured to listen on port 3000
./venv/bin/python3 hvm.py
